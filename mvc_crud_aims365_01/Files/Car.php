...
<?php /*delete data from database*/
	if(isset($_GET['delid'])){
		$delid = $_GET['delid']; 
		$qry_delete_mobile = "DELETE FROM tb_car WHERE id=$delid";
...
?>
	<tr>
		...
		<td>
			...
			<a href="?page=Car&upid=<?php echo $mobile['id']; ?>" class="btn btn-warning btn-sm">Update</a>
			<a href="?page=Car&delid=<?php echo $mobile['id']; ?>" class="btn btn-danger btn-sm">Remove</a>
		</td>
	</tr>
<!-------------------------------------------------------------->
<!-- Modal -->
