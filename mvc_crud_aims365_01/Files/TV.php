...
<?php /*INSERT NEW DATA */
	if(isset($_POST['laptop'])){
		...
		if(empty($company) OR empty($model) OR empty($details) OR empty($price)){
			...
			$mobile_query = "INSERT INTO tb_tv (company,model,details,price) VALUES ('$company','$model','$details','$price')";
...
<!-------------------------------->
<?php 
	$mobile_load_qry = "SELECT * FROM tb_tv";
...
?>
	<tr>
		...
		<td>
			...
			<a href="?page=TV&upid=<?php echo $mobile['id']; ?>" class="btn btn-warning btn-sm">Update</a>
			<a href="?page=TV&delid=<?php echo $mobile['id']; ?>" class="btn btn-danger btn-sm">Remove</a>
		</td>
	</tr>
<!-------------------------------------------------------------->
<!-- Modal -->
